...
extern size_t __zzip_get64(zzip_byte_t * s) ZZIP_GNUC_CONST;
...
#define zzip_disk64_trailer_rootsize(__p) ((zzip_size_t) \
        zzip_disk64_trailer_get_rootsize(__p))
#define zzip_disk64_trailer_rootseek(__p) ((zzip_size_t) \
